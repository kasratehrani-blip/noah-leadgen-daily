...
(async () => {
  const [,, inp, out, orient] = process.argv;
  ...
  await pg.pdf({ path: out, format: 'A4', landscape: orient === 'landscape', printBackground: true, margin: { top: '14mm', bottom: '14mm', left: '14mm', right: '14mm' } });
  await b.close();
